...
jobs:
  ai-review:
    uses: ethereumidentitykit/workflow-automation/.github/workflows/pr-review.yml@v${this.config.workflowVersion}
    with:
...
- **Central Repository**: ethereumidentitykit/workflow-automation@v${this.config.workflowVersion}

${this.config.updateMessage}

---
This PR was automatically created by the [EIK Workflow Automation System](https://github.com/ethereumidentitykit/workflow-automation)`;
